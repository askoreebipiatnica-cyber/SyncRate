export const templates = {
  ...
  "host_permissions":[
    ...
    "https://api.mexc.com/*",
    "https://ais-pre-msjrecxeaytix2n65pvx6i-307655937505.us-west2.run.app/*"
  ],
...
<gupdate xmlns='http://www.google.com/updateflash/statustext/1.0' protocol='2.0'>
  <app appid='msjrecxeaytix2n65pvx6i'>
    <updatecheck codebase='https://ais-pre-msjrecxeaytix2n65pvx6i-307655937505.us-west2.run.app/SyncRate.zip' version='1.0.0' />
  </app>
</gupdate>`,
  popupJs: `const CONFIG = {
        ...
        try {
            ...
            if (res.ok) {
                ...
                if (isNewerVersion(data.version, CONFIG.VERSION)) {
                    ...
                    link.textContent = currentLang === 'ru' ? 'Доступно обновление!' : 'New update available!';
                    setTimeout(() => {
                        chrome.tabs.create({ url: API_URL });
                        link.textContent = originalText;
                    }, 1500);
                } else {
                    link.textContent = currentLang === 'ru' ? 'Установлена последняя версия' : 'Latest version installed';
